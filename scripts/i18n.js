const I18N = (() => {
  const translations = {
    en: {
      ...
      'welcome.getStarted.title': 'To get started with Algolog',
      ...
      'welcome.starOnGithub': 'Star <span class="star-logo-name">Algolog</span> on GitHub',
      ...
      'welcome.error.linking301': 'Error linking <a target="blank" href="https://github.com/${name}">${name}</a> to Algolog. <br> This repository has been moved permanently. Try creating a new one.',
      'welcome.error.linking403': 'Error linking <a target="blank" href="https://github.com/${name}">${name}</a> to Algolog. <br> Forbidden action. Please make sure you have the right access to this repository.',
      'welcome.error.linking404': 'Error linking <a target="blank" href="https://github.com/${name}">${name}</a> to Algolog. <br> Resource not found. Make sure you enter the right repository name.',
      'welcome.success.linked': 'Successfully linked <a target="blank" href="${url}">${name}</a> to Algolog.<br/>Start solving on <a href="https://www.acmicpc.net/">BOJ</a> · <a href="https://school.programmers.co.kr/">Programmers</a> · <a href="https://swexpertacademy.com/">SWEA</a> · <a href="https://level.goorm.io/">Goorm</a>!',
      ...
      'welcome.error.auth': 'Authorization error - Grant Algolog access to your GitHub account to continue (launch extension to proceed)',
      'welcome.error.improperAuth': 'Improper Authorization error - Grant Algolog access to your GitHub account to continue (launch extension to proceed)',
      'welcome.error.authTopRight': 'Authorization error - Grant Algolog access to your GitHub account to continue (click Algolog extension on the top right to proceed)',
      'welcome.error.improperAuthTopRight': 'Improper Authorization error - Grant Algolog access to your GitHub account to continue (click Algolog extension on the top right to proceed)',
      ...
      'welcome.tokenStatus.expired': 'Token has expired or is invalid. Please re-authenticate by clicking the Algolog extension icon in the top right.',
      ...
      'popup.auth.text': 'Authenticate with GitHub to use <strong>Algolog</strong>',
      'popup.auth.button': 'Authenticate',
      'popup.hook.text': 'Set up repository hook to use <strong>Algolog</strong>',
    ...
    ko: {
      ...
      'welcome.getStarted.title': 'Algolog 설정',
      ...
      'welcome.starOnGithub': 'GitHub에서 <span class="star-logo-name">Algolog</span>에 Star\u2B50 한 번 부탁드려요',
      ...
      'welcome.error.authTopRight': 'GitHub 인증이 필요해요. 오른쪽 위의 Algolog 아이콘을 클릭해주세요.',
      'welcome.error.improperAuthTopRight': 'GitHub 인증이 제대로 되지 않았어요. 오른쪽 위의 Algolog 아이콘을 클릭해주세요.',
      ...
      'welcome.tokenStatus.expired': '토큰이 만료되었거나 유효하지 않습니다. 오른쪽 위의 Algolog 아이콘을 클릭하여 재인증해주세요.',
      ...
      'popup.auth.text': '<strong>Algolog</strong> 사용을 위해 GitHub 인증이 필요합니다',
      'popup.auth.button': '인증하기',
      'popup.hook.text': '<strong>Algolog</strong> 사용을 위해 저장소를 설정하세요',
